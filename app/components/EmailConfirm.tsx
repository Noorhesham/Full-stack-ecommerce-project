...
export const SlackConfirmEmail = ({ link }: SlackConfirmEmailProps) => (
  <Html>
    <Head />
    ...
    <Body style={main}>
      <Container style={container}>
        <Section style={logoContainer}>
          <Img src={`${baseUrl}/logo1.jpg`} width="120" height="36" alt="Slack" />
        </Section>
        <Heading style={h1}>Confirm your email address</Heading>
        <Link href={link} style={heroText}>
          Click here to confirm your email. this link will redirect you to a page to confirm your email
        </Link>

        <Section style={codeBox}>
          <Text style={confirmationCodeText}>{link}</Text>
        </Section>
...
export const ConfirmEmail = (props: SlackConfirmEmailProps) =>
  render(<SlackConfirmEmail {...props} />, {
    pretty: true,
  });
